  ...
  module Collections
    module People
      ...
      class GoogleSpreadsheetPerson < Person
        ...
        attr_accessor :address, :buttons, :departments, :email, :expertise, :guides, :image, :jobtitle, :keywords, :location, :netid, :phone, :space, :status, :subtitle, :title, :twitter, :publications
