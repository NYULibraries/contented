  ...
  module Collections
    module PeopleHelpers
      ...
      class ExpandedPerson < Person
        extend Forwardable
        def_delegators :@GoogleSpreadsheetPerson, :about, :address, :buttons, :departments, :email, :expertise, :guides, :image, :jobtitle, :keywords, :location, :netid, :phone, :space, :status, :subtitle, :title, :twitter
